  ...
  return (
    <div>
      <div class="container-fluid">
        <div class="row header py-2 px-xl-5">
        ...
        <div class="row align-items-center py-3 px-xl-5">
          <div class="col-lg-3 d-none d-lg-block">
            <a href="" class="text-decoration-none">
              <h1 class="m-0 display-5 font-weight-semi-bold brand">
                <span class="brand font-weight-bold border px-3 mr-1">E</span>
                Shopper
              </h1>
            </a>
          </div>
      ...
      <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            ...
            >
              <h1
                class="fa fa-shipping-fast  m-0 mr-2"
                style={{ color: "#28e7c1" }}
              ></h1>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            ...
            >
              <h1
                class="fas fa-exchange-alt m-0 mr-3"
                style={{ color: "#28e7c1" }}
              ></h1>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            ...
            >
              <h1
                class="fa fa-phone-volume m-0 mr-3"
                style={{ color: "#28e7c1" }}
              ></h1>
            ...
            <div class="card product-item border-0 mb-4">
              <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                <img
                  ...
                  src="https://m.media-amazon.com/images/I/71ad8PSy5kL._AC_UL320_.jpg"
                  alt=""
                />
              </div>
